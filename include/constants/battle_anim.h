...
#define ANIM_PLAYER_MIDDLE    (MAX_BATTLERS_COUNT + 1)
#define ANIM_PLAYER_RIGHT     (MAX_BATTLERS_COUNT + 2)
#define ANIM_OPPONENT_LEFT    (MAX_BATTLERS_COUNT + 3)
#define ANIM_OPPONENT_MIDDLE  (MAX_BATTLERS_COUNT + 4)
#define ANIM_OPPONENT_RIGHT   (MAX_BATTLERS_COUNT + 5)
#define ANIM_ATTACKER_FORCE   (MAX_BATTLERS_COUNT + 6)
