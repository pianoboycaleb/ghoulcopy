...
static void Task_TryBecomeLinkLeader(u8 taskId)
{
    ...
    case LL_STATE_INIT:
        ...
        break;
    case LL_STATE_INIT2:
        data->incomingPlayerList = AllocZeroedTest(RFU_CHILD_MAX * sizeof(struct RfuIncomingPlayer));
        data->playerList = AllocZeroedTest(MAX_RFU_PLAYERS * sizeof(struct RfuPlayer));
        data->playerListBackup = AllocZeroedTest(MAX_RFU_PLAYERS * sizeof(struct RfuPlayer));
...
static void Task_TryJoinLinkGroup(u8 taskId)
{
    ...
    case LG_STATE_INIT:
        ...
        data->incomingPlayerList = AllocZeroedTest(RFU_CHILD_MAX * sizeof(struct RfuIncomingPlayer));
        data->playerList = AllocZeroedTest(MAX_RFU_PLAYER_LIST_SIZE * sizeof(struct RfuPlayer));
...
void RunUnionRoom(void)
{
    ...
    uroom = AllocZeroedTest(sizeof(*sWirelessLinkMain.uRoom));
...
static void Task_RunUnionRoom(u8 taskId)
{
    ...
    {
    case UR_STATE_INIT:
        uroom->incomingChildList = AllocZeroedTest(RFU_CHILD_MAX * sizeof(struct RfuIncomingPlayer));
        uroom->incomingParentList = AllocZeroedTest(RFU_CHILD_MAX * sizeof(struct RfuIncomingPlayer));
        uroom->playerList = AllocZeroedTest(MAX_UNION_ROOM_LEADERS * sizeof(struct RfuPlayer));
        uroom->spawnPlayer = AllocZeroedTest(sizeof(struct RfuPlayer));
...
void InitUnionRoom(void)
{
    ...
    sWirelessLinkMain.uRoom = data = AllocZeroedTest(sizeof(struct WirelessLink_URoom));
...
static void Task_InitUnionRoom(u8 taskId)
{
    ...
    case 1:
        ...
        break;
    case 2:
        data->incomingChildList = AllocZeroedTest(RFU_CHILD_MAX * sizeof(struct RfuIncomingPlayer));
        ClearIncomingPlayerList(data->incomingChildList, RFU_CHILD_MAX);
        data->incomingParentList = AllocZeroedTest(RFU_CHILD_MAX * sizeof(struct RfuIncomingPlayer));
        ClearIncomingPlayerList(data->incomingParentList, RFU_CHILD_MAX);
        data->playerList = AllocZeroedTest(MAX_UNION_ROOM_LEADERS * sizeof(struct RfuPlayer));
        ClearRfuPlayerList(data->playerList->players, MAX_UNION_ROOM_LEADERS);
        data->spawnPlayer = AllocZeroedTest(sizeof(struct RfuPlayer));
