...
const u8 gMonBattleIcon_VenusaurMega[] = INCBIN_U8("graphics/pokemon/venusaur/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_CharizardMegaX[] = INCBIN_U8("graphics/pokemon/charizard/mega_x/battle_icon.4bpp");
const u8 gMonBattleIcon_CharizardMegaY[] = INCBIN_U8("graphics/pokemon/charizard/mega_y/battle_icon.4bpp");
const u8 gMonBattleIcon_BlastoiseMega[] = INCBIN_U8("graphics/pokemon/blastoise/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_BeedrillMega[] = INCBIN_U8("graphics/pokemon/beedrill/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_PidgeotMega[] = INCBIN_U8("graphics/pokemon/pidgeot/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AlakazamMega[] = INCBIN_U8("graphics/pokemon/alakazam/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SlowbroMega[] = INCBIN_U8("graphics/pokemon/slowbro/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_GengarMega[] = INCBIN_U8("graphics/pokemon/gengar/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_KangaskhanMega[] = INCBIN_U8("graphics/pokemon/kangaskhan/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_PinsirMega[] = INCBIN_U8("graphics/pokemon/pinsir/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_GyaradosMega[] = INCBIN_U8("graphics/pokemon/gyarados/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AerodactylMega[] = INCBIN_U8("graphics/pokemon/aerodactyl/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_MewtwoMegaX[] = INCBIN_U8("graphics/pokemon/mewtwo/mega_x/battle_icon.4bpp");
const u8 gMonBattleIcon_MewtwoMegaY[] = INCBIN_U8("graphics/pokemon/mewtwo/mega_y/battle_icon.4bpp");
const u8 gMonBattleIcon_AmpharosMega[] = INCBIN_U8("graphics/pokemon/ampharos/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SteelixMega[] = INCBIN_U8("graphics/pokemon/steelix/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_ScizorMega[] = INCBIN_U8("graphics/pokemon/scizor/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_HeracrossMega[] = INCBIN_U8("graphics/pokemon/heracross/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_HoundoomMega[] = INCBIN_U8("graphics/pokemon/houndoom/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_TyranitarMega[] = INCBIN_U8("graphics/pokemon/tyranitar/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SceptileMega[] = INCBIN_U8("graphics/pokemon/sceptile/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_BlazikenMega[] = INCBIN_U8("graphics/pokemon/blaziken/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SwampertMega[] = INCBIN_U8("graphics/pokemon/swampert/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_GardevoirMega[] = INCBIN_U8("graphics/pokemon/gardevoir/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SableyeMega[] = INCBIN_U8("graphics/pokemon/sableye/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_MawileMega[] = INCBIN_U8("graphics/pokemon/mawile/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AggronMega[] = INCBIN_U8("graphics/pokemon/aggron/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_MedichamMega[] = INCBIN_U8("graphics/pokemon/medicham/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_ManectricMega[] = INCBIN_U8("graphics/pokemon/manectric/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SharpedoMega[] = INCBIN_U8("graphics/pokemon/sharpedo/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_CameruptMega[] = INCBIN_U8("graphics/pokemon/camerupt/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AltariaMega[] = INCBIN_U8("graphics/pokemon/altaria/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_BanetteMega[] = INCBIN_U8("graphics/pokemon/banette/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AbsolMega[] = INCBIN_U8("graphics/pokemon/absol/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_GlalieMega[] = INCBIN_U8("graphics/pokemon/glalie/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_SalamenceMega[] = INCBIN_U8("graphics/pokemon/salamence/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_MetagrossMega[] = INCBIN_U8("graphics/pokemon/metagross/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_LatiasMega[] = INCBIN_U8("graphics/pokemon/latias/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_LatiosMega[] = INCBIN_U8("graphics/pokemon/latios/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_LopunnyMega[] = INCBIN_U8("graphics/pokemon/lopunny/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_GarchompMega[] = INCBIN_U8("graphics/pokemon/garchomp/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_LucarioMega[] = INCBIN_U8("graphics/pokemon/lucario/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AbomasnowMega[] = INCBIN_U8("graphics/pokemon/abomasnow/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_GalladeMega[] = INCBIN_U8("graphics/pokemon/gallade/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_AudinoMega[] = INCBIN_U8("graphics/pokemon/audino/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_DiancieMega[] = INCBIN_U8("graphics/pokemon/diancie/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_RayquazaMega[] = INCBIN_U8("graphics/pokemon/rayquaza/mega/battle_icon.4bpp");
const u8 gMonBattleIcon_KyogrePrimal[] = INCBIN_U8("graphics/pokemon/kyogre/primal/battle_icon.4bpp");
const u8 gMonBattleIcon_GroudonPrimal[] = INCBIN_U8("graphics/pokemon/groudon/primal/battle_icon.4bpp");
const u8 gMonBattleIcon_RattataAlolan[] = INCBIN_U8("graphics/pokemon/rattata/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_RaticateAlolan[] = INCBIN_U8("graphics/pokemon/raticate/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_RaichuAlolan[] = INCBIN_U8("graphics/pokemon/raichu/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_SandshrewAlolan[] = INCBIN_U8("graphics/pokemon/sandshrew/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_SandslashAlolan[] = INCBIN_U8("graphics/pokemon/sandslash/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_VulpixAlolan[] = INCBIN_U8("graphics/pokemon/vulpix/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_NinetalesAlolan[] = INCBIN_U8("graphics/pokemon/ninetales/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_DiglettAlolan[] = INCBIN_U8("graphics/pokemon/diglett/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_DugtrioAlolan[] = INCBIN_U8("graphics/pokemon/dugtrio/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_MeowthAlolan[] = INCBIN_U8("graphics/pokemon/meowth/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_PersianAlolan[] = INCBIN_U8("graphics/pokemon/persian/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_GeodudeAlolan[] = INCBIN_U8("graphics/pokemon/geodude/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_GravelerAlolan[] = INCBIN_U8("graphics/pokemon/graveler/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_GolemAlolan[] = INCBIN_U8("graphics/pokemon/golem/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_GrimerAlolan[] = INCBIN_U8("graphics/pokemon/grimer/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_MukAlolan[] = INCBIN_U8("graphics/pokemon/muk/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_ExeggutorAlolan[] = INCBIN_U8("graphics/pokemon/exeggutor/alolan/battle_icon.4bpp");
const u8 gMonBattleIcon_MarowakAlolan[] = INCBIN_U8("graphics/pokemon/marowak/alolan/battle_icon.4bpp");
