...
static void Fill1PRecords(struct RankingHall1P *dst, s32 hallFacilityId, s32 lvlMode)
{
    ...
    struct PlayerHallRecords *playerHallRecords = AllocZeroedTest(sizeof(struct PlayerHallRecords));
...
{
    s32 i;
    struct Pokemon *monsParty = AllocZeroedTest(sizeof(struct Pokemon) * PARTY_SIZE);
